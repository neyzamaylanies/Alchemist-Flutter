    ...
    return Column(
      ...
      children: [
        ...
        Text('Dashboard', style: TextStyle(
          fontFamily: AppTheme.fontFamily, fontSize: 22,
          ...
          builder: (context, trxState) {
            return BlocBuilder<StudentListBloc, StudentListState>(
              ...
              builder: (context, stuState) {
                ...
                final cards = [
                  _StatCardData('Total Peralatan', totalEq.toString(), Icons.science_rounded, AppTheme.primaryGradient, 2),
                  _StatCardData('Alat Tersedia', availableEq.toString(), Icons.check_circle_rounded, AppTheme.blueGradient, 2),
                  _StatCardData('Alat Rusak', damagedEq.toString(), Icons.warning_rounded, AppTheme.purpleGradient, 2, warning: damagedEq > 0),
                  _StatCardData('Total Transaksi', totalTrx.toString(), Icons.swap_horiz_rounded, AppTheme.periwinkleGradient, 1),
                  _StatCardData('Mahasiswa', totalStu.toString(), Icons.people_rounded, AppTheme.violetGradient, 3),
                ];
                ...
                if (isMobile) {
                  ...
                  return GridView.count(
                    ...
                    children: cards.map((c) => _StatCard(
                      ...
                      gradient: c.gradient, warningValue: c.warning,
                      onTap: () => onNavigate(c.navIndex),
                    )).toList(),
                  );
                }
        ...
        return Column(
          ...
          children: [
            Row(children: [
              ...
              Text('Perlu Perhatian', style: TextStyle(
              ...
              Container(
                ...
                child: Text('${needAttention.length}',
                  style: const TextStyle(color: Colors.white, fontSize: 11,
                    fontWeight: FontWeight.w700, fontFamily: AppTheme.fontFamily)),
              ),
            ]),
                  ...
                  return Container(
                    ...
                    decoration: BoxDecoration(
                      border: Border(bottom: BorderSide(
                        color: (isDark ? AppTheme.darkBorder : const Color(0xFFE5E7EB)).withValues(alpha: 0.5))),
                    ),
                    child: Row(children: [
                      Container(
    ...
    return Column(
      ...
      children: [
        Row(children: [
          ...
          GestureDetector(
            onTap: () => onNavigate(1),
            child: Text('Lihat semua', style: const TextStyle(
        ...
        BlocBuilder<TransactionListBloc, TransactionListState>(
          ...
          builder: (context, state) {
            ...
            if (state is TransactionListLoaded && state.transactions.isNotEmpty) {
              return Container(
                decoration: BoxDecoration(
                  color: isDark ? AppTheme.darkSurface : AppTheme.surface,
                  borderRadius: BorderRadius.circular(12),
                  ...
                  children: state.transactions.take(5).map((t) {
                    ...
                    return Container(
                      ...
                      child: Row(children: [
                        ...
                        Expanded(child: Column(
                          ...
                          children: [
                            Text(t.id, style: TextStyle(
                              fontFamily: AppTheme.fontFamily, fontWeight: FontWeight.w600,
                              fontSize: 13, color: isDark ? AppTheme.darkText : AppTheme.textPrimary)),
                            Text(t.equipmentId, style: TextStyle(
                              fontFamily: AppTheme.fontFamily,
                              color: isDark ? AppTheme.darkTextSub : AppTheme.textSecondary,
                              fontSize: 12)),
                          ],
                        ...
                        const SizedBox(width: 12),
                        Text('${t.quantity}x', style: TextStyle(
                          fontFamily: AppTheme.fontFamily, fontWeight: FontWeight.w700,
                          fontSize: 14, color: isDark ? AppTheme.darkText : AppTheme.textPrimary)),
                      ]),
                    );
                  }).toList(),
                ),
            ...
            return _buildEmptyState('Belum ada transaksi', Icons.swap_horiz_rounded, isDark);
          },
        ),
      ],
    );
  ...
  Widget _buildEmptyState(String message, IconData icon, bool isDark) {
    return Container(
      ...
      child: Center(child: Column(children: [
        Icon(icon, size: 48, color: isDark ? AppTheme.darkTextSub : AppTheme.textMuted),
        const SizedBox(height: 12),
...
class _StatCardData {
  ...
  final int navIndex;
  final bool warning;
  _StatCardData(this.label, this.value, this.icon, this.gradient, this.navIndex, {this.warning = false});
}
...
class _StatCard extends StatelessWidget {
  ...
  const _StatCard({
    ...
    required this.gradient, required this.onTap, this.warningValue = false,
  });
            ...
            Column(
              ...
              children: [
                Text(value, style: TextStyle(
                  ...
                  color: warningValue && value != '0' ? AppTheme.error : textColor)),
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Text(label, style: TextStyle(
        ...
        fontWeight: FontWeight.w600, fontFamily: AppTheme.fontFamily)),
    );
  }
}
        ...
        children: List.generate(3, (i) => Container(
          ...
          child: Row(children: [
            ...
            Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              _SkeletonBox(width: 120, height: 12, radius: 4, isDark: isDark),
              const SizedBox(height: 6),
              _SkeletonBox(width: 80, height: 10, radius: 4, isDark: isDark),
            ])),
...
class _SkeletonBox extends StatelessWidget {
  ...
  const _SkeletonBox({required this.width, required this.height,
    required this.radius, required this.isDark});
