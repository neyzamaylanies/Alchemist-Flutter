...
class _TransactionListPageState extends State<TransactionListPage> {
  String      _searchQuery = '';
  _SortOrder  _sortOrder   = _SortOrder.newestFirst; // default: terbaru dulu
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // Search + Sort filter dalam satu baris
                  Row(children: [
                    Expanded(
                      child: TextField(
                ...
                builder: (context, state) {
                  ...
                  transactions.sort((a, b) {
                    ...
                    return _sortOrder == _SortOrder.newestFirst
                        ? dateB.compareTo(dateA)  // terbaru dulu
                        : dateA.compareTo(dateB); // terlama dulu
                  });
